...
<section id="service-page" class="pages service-page">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="block">
                    <img class="img-responsive" src="public/assets/global/images/team.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-3">
                 <figure class="wow fadeInLeft animated portfolio-item" data-wow-duration="500ms" data-wow-delay="0ms">
                    <div class="img-wrapper">
                        <img src="public/assets/global/images/portfolio/item-1.jpg" class="img-responsive" alt="this is a title" >
                        <div class="overlay">
                            <div class="buttons">
            ...
            <div class="col-sm-3">
                <figure class="wow fadeInLeft animated" data-wow-duration="500ms" data-wow-delay="300ms">
                    <div class="img-wrapper">
                        <img src="public/assets/global/images/portfolio/item-2.jpg" class="img-responsive" alt="this is a title" >
                        <div class="overlay">
                            <div class="buttons">
            ...
            <div class="col-sm-3">
                <figure class="wow fadeInLeft animated" data-wow-duration="500ms" data-wow-delay="300ms">
                    <div class="img-wrapper">
                        <img src="public/assets/global/images/portfolio/item-3.jpg" class="img-responsive" alt="" >
                        <div class="overlay">
                            <div class="buttons">
            ...
            <div class="col-sm-3">
                <figure class="wow fadeInLeft animated" data-wow-duration="500ms" data-wow-delay="600ms">
                    <div class="img-wrapper">
                        <img src="public/assets/global/images/portfolio/item-4.jpg" class="img-responsive" alt="" >
                        <div class="overlay">
                            <div class="buttons">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div id="clients-logo" class="owl-carousel">
                    <div>
                        <img src="public/assets/global/images/clients/logo-1.jpg" alt="">
                    </div>
                    <div>
                        <img src="public/assets/global/images/clients/logo-2.jpg" alt="">
                    </div>
                    <div>
                        <img src="public/assets/global/images/clients/logo-3.jpg" alt="">
                    </div>
                    <div>
                        <img src="public/assets/global/images/clients/logo-4.jpg" alt="">
                    </div>
                    <div>
                        <img src="public/assets/global/images/clients/logo-5.jpg" alt="">
                    </div>
                     <div>
                        <img src="public/assets/global/images/clients/logo-1.jpg" alt="">
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block">
                    ...
                    <a href="{{URL::to('contact')}}" class="btn btn-default btn-contact wow fadeInDown" data-wow-delay=".7s" data-wow-duration="500ms">Contact With Me</a>
                </div>
            </div>
